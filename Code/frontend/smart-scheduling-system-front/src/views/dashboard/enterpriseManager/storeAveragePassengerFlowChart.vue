...
export default {
  ...
  data() {
    return {
      ...
      averagePassengerFlowList: undefined,
      loading: true
    }
  },
  mounted() {
  ...
  methods: {
        ...
        series: [
          {
            ...
            data: this.averagePassengerFlowList,
            itemStyle: {
              color: '#58afdd'
            }
          }
    ...
    statisticsStoreUserNum() {
      return new Promise((resolve, reject) => {
        ...
        shiftSchedulingStatisticsApi.getAveragePassengerFlow(param).then(
          res => {
            this.storeNameList = res.storeNameList;
            this.averagePassengerFlowList = res.averagePassengerFlowList;
