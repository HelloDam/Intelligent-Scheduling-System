  ...
  methods: {
        ...
        series: [
          {
            ...
            data: this.averageShiftAllocationRateList,
            itemStyle: {
              color: '#46a2da'
            }
          }
    ...
    statisticsStoreUserNum() {
      return new Promise((resolve, reject) => {
        ...
        shiftSchedulingStatisticsApi.getStoreShiftNumAndAllocationRate(param).then(
          res => {
            this.storeNameList = res.storeNameList;
            this.averageShiftAllocationRateList = res.averageShiftAllocationRateList;
