...
export default {
  ...
  data() {
    return {
      ...
      averageStaffWorkTimeList: undefined,
    }
  },
  mounted() {
    this.$nextTick(() => {
  ...
  methods: {
        ...
        series: [
          {
            ...
            data: this.averageStaffWorkTimeList,
            itemStyle: {
              color: '#58afdd'
            }
          }
    ...
    statisticsStoreUserNum() {
      return new Promise((resolve, reject) => {
        ...
        shiftSchedulingStatisticsApi.getMonthAverageStaffWorkTime(param).then(
          res => {
            this.monthNameList = res.monthNameList;
            this.averageStaffWorkTimeList = res.averageStaffWorkTimeList;
