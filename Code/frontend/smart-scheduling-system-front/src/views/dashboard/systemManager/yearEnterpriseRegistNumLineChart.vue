...
import enterpriseStatisticsApi from '@/api/statistics/enterpriseStatistics'
...
export default {
  ...
  data() {
    return {
      ...
      registerEnterpriseNumList: undefined,
  ...
  mounted() {
    this.$nextTick(() => {
      this.initChart();
      // this.enterpriseStatisticsApi().then(
      //   () => {
      //     this.initChart();
      //     this.setOptions();
      //   }
  ...
  methods: {
        ...
        series: [
          {
            ...
            data: this.registerEnterpriseNumList,
            itemStyle: {
              color: '#4194cb'
            }
          }
     ...
     */
    enterpriseStatisticsApi() {
      return new Promise((resolve, reject) => {

        let param = { year: this.year }
        // console.log("param:" + JSON.stringify(param))
        enterpriseStatisticsApi.getRegisterEnterpriseNumOfYear(param).then(
          res => {
            this.monthNameList = res.monthNameList;
            this.registerEnterpriseNumList = res.registerEnterpriseNumList;
            resolve();
          }
        )
      })
